...
export default class RightSidebar extends React.Component {
  render () {
    return (
      <aside className="control-sidebar control-sidebar-light">{/* Control Sidebar */}
        {/* Create the tabs */}
        ...
        <div className="tab-content">
          ...
          {/* Stats tab content */}
          <div className="tab-pane" id="control-sidebar-stats-tab">Stats Tab Content</div>{/* /.tab-pane */}
